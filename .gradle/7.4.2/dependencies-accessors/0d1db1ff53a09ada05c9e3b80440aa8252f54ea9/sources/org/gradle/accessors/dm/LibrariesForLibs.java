...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KtorLibraryAccessors extends SubDependencyFactory {
        ...
        private final KtorEngineLibraryAccessors laccForKtorEngineLibraryAccessors = new KtorEngineLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at ktor.engine
         */
        public KtorEngineLibraryAccessors getEngine() { return laccForKtorEngineLibraryAccessors; }
    ...
    public static class KtorEngineLibraryAccessors extends SubDependencyFactory {

        public KtorEngineLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for cio (io.ktor:ktor-client-cio)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCio() { return create("ktor.engine.cio"); }

            /**
             * Creates a dependency provider for js (io.ktor:ktor-client-js)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getJs() { return create("ktor.engine.js"); }

            /**
             * Creates a dependency provider for winhttp (io.ktor:ktor-client-winhttp)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getWinhttp() { return create("ktor.engine.winhttp"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: ktor (2.3.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class BundleAccessors extends BundleFactory {
        private final CommonBundleAccessors baccForCommonBundleAccessors = new CommonBundleAccessors(providers, config);
         ...
         */
        public CommonBundleAccessors getCommon() { return baccForCommonBundleAccessors; }

    }

    public static class CommonBundleAccessors extends BundleFactory {

        public CommonBundleAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a dependency bundle provider for common.main which is an aggregate for the following dependencies:
             * <ul>
             ...
             */
            public Provider<ExternalModuleDependencyBundle> getMain() { return createBundle("common.main"); }
